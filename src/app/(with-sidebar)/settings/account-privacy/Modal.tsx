    ...
    <>
      <div className="border-foreground/10 relative flex items-center justify-between rounded-xl border px-4 py-6">
        ...
        <Switch
          ...
          className="group bg-foreground/20 data-[checked]:bg-foreground data-[focus]:outline-foreground relative flex h-7 w-12 cursor-pointer rounded-full p-1 transition-colors duration-200 ease-in-out focus:outline-none data-[focus]:outline-1"
        >
          <span
            aria-hidden="true"
